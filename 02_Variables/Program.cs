...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine();
            //Console.WriteLine("---------------------------");
            //Console.WriteLine("Yolcu TC Kimlik Numarası " + passangerIdentityNumber + " Yolcu Bilgileri: " + passangerName + " " + passangerSurname + " " + passangerDistrict + " " + passangerCity + " " + passangerAge);
